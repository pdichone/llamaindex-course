...
class ContextChatEngine extends _Mixin.PromptMixin {
    ...
    async chat(params) {
        ...
        if (stream) {
            ...
            }), (r)=>_schema.EngineResponse.fromChatResponseChunk(r, requestMessages.nodes));
        }
        const response = await this.chatModel.chat({
            messages: requestMessages.messages
        });
        chatHistory.addMessage(response.message);
        return _schema.EngineResponse.fromChatResponse(response, requestMessages.nodes);
    }
    reset() {
    ...
    prependSystemPrompt(message) {
        ...
        return {
            ...message,
            content: this.systemPrompt.trim() + "\n" + (0, _utils.extractText)(message.content)
        };
    }
}
