...
class SummaryChatHistory extends ChatHistory {
   ...
   */ tokenizer;
    ...
    constructor(init){
        ...
        this.tokenizer = init?.tokenizer ?? _env.tokenizers.tokenizer();
   ...
   */ calcConversationMessages(transformSummary) {
    ...
    async requestMessages(transientMessages) {
        ...
        const tokens = requestMessages.reduce((count, message)=>count + this.tokenizer.encode((0, _utils.extractText)(message.content)).length, 0);
