...
var fetchWithHeaders = (_0, _1, ..._2)=>__async(void 0, [
        _0,
        _1,
        ..._2
...
var get = (fetch2, host)=>__async(void 0, null, function*() {
        const response = yield fetchWithHeaders(fetch2, host);
        yield checkOk(response);
        return response;
    });
var post = (fetch2, host, data, options)=>__async(void 0, null, function*() {
...
var del = (fetch2, host, data)=>__async(void 0, null, function*() {
        const response = yield fetchWithHeaders(fetch2, host, {
            method: "DELETE",
...
var Ollama = class {
    ...
    processStreamableRequest(endpoint, request) {
        return __async(this, null, function*() {
            ...
            const response = yield post(this.fetch, `${this.config.host}/api/${endpoint}`, __spreadValues({}, request), {
            ...
            if (request.stream) {
                return function() {
                    return __asyncGenerator(this, null, function*() {
                        try {
                            for(var iter = __forAwait(itr), more, temp, error; more = !(temp = yield new __await(iter.next())).done; more = false){
