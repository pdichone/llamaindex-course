...
var require_identifier = __commonJS({
    "lib/identifier.js" (exports1, module) {
        "use strict";
       ...
       */ static parse(ref) {
                const match = ref.match(new RegExp("^(?<owner>[^/]+)\\/(?<name>[^/:]+)(:(?<version>.+))?$"));
                if (!match) {
    ...
    "lib/util.js" (exports1, module) {
        ...
        function validateWebhook(requestData, secret) {
            return __async(this, null, function*() {
                ...
                const computedSignature = yield createHMACSHA256(signingSecret.split("_").pop(), signedContent);
        ...
        function createHMACSHA256(secret, data) {
            return __async(this, null, function*() {
                ...
                const key = yield crypto.subtle.importKey("raw", base64ToBytes(secret), {
                    name: "HMAC",
                    hash: "SHA-256"
                }, false, [
                    "sign"
        ...
        function transformFileInputs(inputs) {
            return __async(this, null, function*() {
                let totalBytes = 0;
                const result = yield transform(inputs, (value)=>__async(this, null, function*() {
                        let buffer;
                        let mime;
...
var require_stream = __commonJS({
    "vendor/eventsource-parser/stream.js" (exports1, module) {
        "use strict";
        ...
        var __copyProps = (to, from, except, desc)=>{
            if (from && typeof from === "object" || typeof from === "function") {
                for (const key of __getOwnPropNames2(from))if (!__hasOwnProp2.call(to, key) && key !== except) __defProp2(to, key, {
                    get: ()=>from[key],
...
var require_text_decoder_stream = __commonJS({
    "vendor/streams-text-encoding/text-decoder-stream.js" (exports1, module) {
        "use strict";
        var __defProp2 = Object.defineProperty;
        var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
        var __getOwnPropNames2 = Object.getOwnPropertyNames;
            ...
            return new ReadableStream({
                start (controller) {
                    return __async(this, null, function*() {
                        ...
                        try {
                            for(var iter = __forAwait(streamAsyncIterator(stream)), more, temp, error; more = !(temp = yield iter.next()).done; more = false){
                                const event = temp.value;
                                if (event.event === "error") {
                                    controller.error(new Error(event.data));
                                    break;
                                }
                                controller.enqueue(new ServerSentEvent(event.event, event.data, event.id));
                                if (event.event === "done") {
                                    break;
                                }
                            }
...
var require_accounts = __commonJS({
    "lib/accounts.js" (exports1, module) {
        "use strict";
...
var require_collections = __commonJS({
    "lib/collections.js" (exports1, module) {
        "use strict";
    ...
    "lib/deployments.js" (exports1, module) {
        ...
        function createPrediction(deployment_owner, deployment_name, options) {
            return __async(this, null, function*() {
                ...
                const response = yield this.request(`/deployments/${deployment_owner}/${deployment_name}/predictions`, {
                    method: "POST",
        ...
        function getDeployment(deployment_owner, deployment_name) {
            return __async(this, null, function*() {
                const response = yield this.request(`/deployments/${deployment_owner}/${deployment_name}`, {
                    method: "GET"
                });
                return response.json();
            });
        ...
        function updateDeployment(deployment_owner, deployment_name, deployment_config) {
            return __async(this, null, function*() {
                const response = yield this.request(`/deployments/${deployment_owner}/${deployment_name}`, {
                    method: "PATCH",
                    data: deployment_config
...
var require_hardware = __commonJS({
    "lib/hardware.js" (exports1, module) {
        "use strict";
...
var require_models = __commonJS({
    "lib/models.js" (exports1, module) {
        "use strict";
        function getModel(model_owner, model_name) {
            return __async(this, null, function*() {
                const response = yield this.request(`/models/${model_owner}/${model_name}`, {
                    method: "GET"
                });
                return response.json();
            });
        ...
        function listModelVersions(model_owner, model_name) {
            return __async(this, null, function*() {
                const response = yield this.request(`/models/${model_owner}/${model_name}/versions`, {
                    method: "GET"
                });
                return response.json();
            });
        ...
        function getModelVersion(model_owner, model_name, version_id) {
            return __async(this, null, function*() {
                const response = yield this.request(`/models/${model_owner}/${model_name}/versions/${version_id}`, {
                    method: "GET"
                });
                return response.json();
            });
...
var require_predictions = __commonJS({
    "lib/predictions.js" (exports1, module) {
        "use strict";
        var { transformFileInputs } = require_util();
        function createPrediction(options) {
            return __async(this, null, function*() {
                const _a = options, { model, version, stream, input } = _a, data = __objRest(_a, [
                    "model",
                    "version",
                    "stream",
                    "input"
        ...
        function cancelPrediction(prediction_id) {
            return __async(this, null, function*() {
                const response = yield this.request(`/predictions/${prediction_id}/cancel`, {
                    method: "POST"
                });
                return response.json();
            });
...
var require_trainings = __commonJS({
    "lib/trainings.js" (exports1, module) {
        "use strict";
        function createTraining(model_owner, model_name, version_id, options) {
            return __async(this, null, function*() {
                ...
                const response = yield this.request(`/models/${model_owner}/${model_name}/versions/${version_id}/trainings`, {
                    method: "POST",
                    data
                });
                return response.json();
        ...
        function cancelTraining(training_id) {
            return __async(this, null, function*() {
                const response = yield this.request(`/trainings/${training_id}/cancel`, {
                    method: "POST"
                });
                return response.json();
            });
...
var require_webhooks = __commonJS({
    "lib/webhooks.js" (exports1, module) {
        "use strict";
...
var require_replicate = __commonJS({
    "index.js" (exports1, module) {
        var ApiError = require_error();
        var ModelVersionIdentifier = require_identifier();
        var { createReadableStream } = require_stream2();
        var { withAutomaticRetries, validateWebhook, parseProgressFromLogs, streamAsyncIterator } = require_util();
       ...
       */ run(ref, options, progress) {
                return __async(this, null, function*() {
                    const _a = options, { wait } = _a, data = __objRest(_a, [
                        "wait"
                    ]);
                    const identifier = ModelVersionIdentifier.parse(ref);
                    let prediction;
                    if (identifier.version) {
                        prediction = yield this.predictions.create(__spreadProps(__spreadValues({}, data), {
                    ...
                    prediction = yield this.wait(prediction, wait || {}, (updatedPrediction)=>__async(this, null, function*() {
                            if (progress) {
       ...
       */ request(route, options) {
                return __async(this, null, function*() {
                    ...
                    const response = yield withAutomaticRetries(()=>__async(this, null, function*() {
       ...
       */ stream(ref, options) {
                return __asyncGenerator(this, null, function*() {
                    ...
                    let prediction;
                    if (identifier.version) {
                        prediction = yield new __await(this.predictions.create(__spreadProps(__spreadValues({}, data), {
                            version: identifier.version,
                            stream: true
                        })));
                    } else if (identifier.owner && identifier.name) {
...
const _default = require_replicate();
